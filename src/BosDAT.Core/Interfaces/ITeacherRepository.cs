...
public interface ITeacherRepository : IRepository<Teacher>
{
    ...
    Task<Teacher?> GetWithInstrumentsAndLessonTypesAsync(Guid id, CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<Teacher>> GetTeachersByLessonTypeAsync(int lessonTypeId, CancellationToken cancellationToken = default);
}
