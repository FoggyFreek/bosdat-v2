...
namespace BosDAT.Infrastructure.Migrations
{
    ...
    [Migration("20260309223832_AddInvoiceEmailSupport")]
    partial class AddInvoiceEmailSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BosDAT.Core.Entities.Absence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BosDAT.Core.Entities.EmailOutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BosDAT.Core.Entities.Setting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Description = "Subject template for invoice emails. Placeholders: {{InvoiceNumber}}, {{SchoolName}}, {{StudentFirstName}}, {{StudentLastName}}, {{Total}}, {{DueDate}}, {{IssueDate}}",
                            Type = "string",
